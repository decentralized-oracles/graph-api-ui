...
import { DEFAULT_NETWORKS, SMART_CONTRACT_ADDRESS, PHAT_CONTRACT_ID } from '../lib/constants';
...
export function ApiStatus(props) {
    ...
    const address = props.context === "astar" ? SMART_CONTRACT_ADDRESS[DEFAULT_NETWORKS[props.context]] : PHAT_CONTRACT_ID[DEFAULT_NETWORKS[props.context]]
